...
const affiliationData = [
  {
    ...
    serviceImage: "https://images.pexels.com/photos/3738334/pexels-photo-3738334.jpeg?auto=compress&cs=tinysrgb&w=200",
    commission: 10,
    expiryDate: "Mon Dec 31 2025",
    affiliationLink: "https://example.com/aff/service1",
    status: "active",
  },
  {
    id: 2,
    ...
    serviceImage: "https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&cs=tinysrgb&w=200",
    commission: 8,
    expiryDate: "Mon Dec 31 2025",
    affiliationLink: "https://example.com/aff/service2",
    status: "active",
  },
  {
    id: 3,
    ...
    serviceImage: "https://images.pexels.com/photos/3997386/pexels-photo-3997386.jpeg?auto=compress&cs=tinysrgb&w=200",
    commission: 12,
    expiryDate: "Mon Dec 31 2025",
    affiliationLink: "https://example.com/aff/service3",
    status: "active",
  },
];

export default function ServiceAffiliationManagementPage() {
  ...
  const handleEdit = (affiliation: typeof affiliationData[0]) => {
    const editData = {
      id: affiliation.id,
      productId: affiliation.serviceId,
      productName: affiliation.serviceName,
      commission: affiliation.commission,
      expiryDate: affiliation.expiryDate,
    };
    setEditingAffiliation(editData);
    setIsEditDialogOpen(true);
  };

  const handleDelete = (id: number) => {
    if (confirm('Are you sure you want to delete this affiliation?')) {
      console.log('Deleting service affiliation:', id);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      <div className="flex">
        <ServiceSidebar activePage="affiliation-management" />

        <div className="flex-1 p-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              <h1 className="text-4xl font-bold text-gray-900">Service Affiliation List</h1>
              <Button
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="text-left py-6 px-6 text-base font-bold text-gray-900">Service Image</th>
                      <th className="text-left py-6 px-6 text-base font-bold text-gray-900">Service Id</th>
                      <th className="text-left py-6 px-6 text-base font-bold text-gray-900">Service Name</th>
                  ...
                  <tbody>
                    {affiliationData.map((item, index) => (
                      <tr key={item.id} className={index !== affiliationData.length - 1 ? "border-b border-gray-100" : ""}>
                        ...
                        <td className="py-6 px-6 text-base text-gray-900">{item.serviceId}</td>
                        <td className="py-6 px-6 text-base text-gray-900">{item.serviceName}</td>
