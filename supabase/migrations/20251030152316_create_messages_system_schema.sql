/*
  ...
  message reactions (like Instagram), shared posts/stories, and message replies.
  ...
  ## 1. New Tables
    ...
    - `messages`
      ...
      - `reply_to_message_id` (uuid) - ID of message being replied to
      - `created_at` (timestamptz)
      - `updated_at` (timestamptz)
  ...
  ## 2. Security
    ...
    - Policies for authenticated users to:
      ...
      - Reply to messages in their conversations
*/
...
CREATE TABLE IF NOT EXISTS messages (
  ...
  CONSTRAINT prevent_self_reply CHECK (id != reply_to_message_id)
);
